...
export function normalizeRecord(record: VehicleRecord): VehicleRecord {
  ...
  return {
    ...
    chassisNumber: record.chassisNumber?.trim() || undefined,
    inspectorNotes: record.inspectorNotes?.trim() || undefined,
    exteriorGrade: record.exteriorGrade?.trim() || undefined,
    exteriorGradeDescription: record.exteriorGradeDescription?.trim() || undefined,
    interiorGrade: record.interiorGrade?.trim() || undefined,
    interiorGradeDescription: record.interiorGradeDescription?.trim() || undefined,
    mileageWarning: record.mileageWarning?.trim() || undefined,
    ownershipHistory: record.ownershipHistory?.trim() || undefined,
