...
### Changed (2026-05-01)
- Removed `dist/` and `bin/` — source-only project, no build step
- Removed `typescript` dependency — runs directly via vitest/tsx
- Added `pnpm crawl` script for dev CLI testing